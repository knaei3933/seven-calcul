...
| --- | --- | --- | --- |
| Frontier (leader) | `glm-5.3` | high | Primary leader/orchestrator for planning, coordination, and frontier-class reasoning. |
...
| `analyst` | `glm-5.3` | medium | Requirements clarity, acceptance criteria, hidden constraints (frontier-orchestrator, frontier) |
...
| `executor` | `glm-5.3` | medium | Code implementation, refactoring, feature work (deep-worker, standard) |
| `team-executor` | `glm-5.3` | medium | Supervised team execution for conservative delivery lanes (deep-worker, frontier) |
| `verifier` | `glm-5.3` | high | Completion evidence, claim validation, test adequacy (frontier-orchestrator, standard) |
| `code-reviewer` | `glm-5.3` | high | Comprehensive review across all concerns (frontier-orchestrator, frontier) |
| `dependency-expert` | `glm-5.3` | high | External SDK/API/package evaluation (frontier-orchestrator, standard) |
| `test-engineer` | `glm-5.3` | medium | Test strategy, coverage, flaky-test hardening (deep-worker, frontier) |
...
| `code-simplifier` | `glm-5.3` | high | Simplifies recently modified code for clarity and consistency without changing behavior (deep-worker, frontier) |
| `researcher` | `gpt-5.6-terra` | high | External documentation and reference research (fast-lane, standard) |
| `critic` | `glm-5.3` | high | Plan/design critical challenge and review (frontier-orchestrator, frontier) |
| `vision` | `glm-5.3` | low | Image/screenshot/diagram analysis (fast-lane, frontier) |
<!-- OMX:MODELS:END -->
...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1788184311113-i0zv4x | 2026-08-31T13:51:51.339Z
