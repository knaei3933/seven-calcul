...
export OMX_TEAM_WORKER='implement-the-approved-pouch-q/worker-4'
export OMX_TEAM_INTERNAL_WORKER='implement-the-approve-57483222/worker-4'
...
export OMX_MODEL_INSTRUCTIONS_FILE='/root/pouch-clacul/.omx/state/team/implement-the-approve-57483222/workers/worker-4/AGENTS.md'
...
exec '\''/root/.local/share/orca/codex-runtime-home/bin/codex'\'' '\''[--model,glm-5.3-flash]'\'' '\''-c'\'' '\''model_reasoning_effort="medium"'\'' '\''--model'\'' '\''glm-5.3'\'' '\''-c'\'' '\''model_instructions_file="/root/pouch-clacul/.omx/state/team/implement-the-approve-57483222/workers/worker-4/AGENTS.md"'\'' '\''--dangerously-bypass-approvals-and-sandbox'\'''